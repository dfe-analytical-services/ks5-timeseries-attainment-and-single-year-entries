...
read_alevel_subject_data <- function(file = "data/all_alevel_timeseries_data_1996_to_2023.csv") {
...
read_alevel_aps_data <- function(file = "data/alevel_attainment_with_prov2023.csv") {
...
read_alevel_aps_gendergap_data <- function(file = "data/aps_gender_gap_with_prov2023.csv") {
...
read_all_attainment_data <- function(file = "data/all_attainment_with_prov2023.csv") {
