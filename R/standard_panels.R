    ...
    gov_main_layout(
      gov_row(
        column(
          ...
          br(
            "This accessibility statement applies to the 16 to 18  time series attainment and single year entries.
          ...
          br(
            ...
            ", which did not detect accessibility issues.
             This application also passes the accessibility audits checked by the ",
            a(
          ...
          br(
            ...
            a(
              href = "mailto:attainment.statistics@education.gov.uk",
    ...
    gov_main_layout(
      gov_row(
        column(
          ...
          a(
            href = "https://forms.office.com/pages/responsepage.aspx?id=yXfS-grGoU2187O4s0qC-Zz2vw_NbKtFvp9cE0vbZ2tUQ1JINVFJSzY4QkpFMkdDOFc4MEJQRkVSRS4u&route=shorturl",
            "feedback form",
            .noWS = c("after")
          ),
          ".",
          ...
          a(
            href = "https://github.com/dfe-analytical-services/ks5-timeseries-attainment-and-single-year-entries",
            "GitHub repository",
            .noWS = c("after")
          ),
          ".",
